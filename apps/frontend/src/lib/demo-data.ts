...
export const demoModels: ModelDto[] = [
  ...
  model(
    'turkce-dil-modeli',
    'Türkçe Dil Modeli',
    'Türkçe metin özetleme, duygu analizi ve sınıflandırma görevleri için özel eğitilmiş transformer modeli.',
    'PYTORCH',
    'cat-language',
    ['tag-monad', 'tag-ipfs', 'tag-nft'],
    '2.3.1',
    2,
  ),
  model(
    'goruntu-tanima-v2',
    'Görüntü Tanıma Modeli v2',
    'ResNet tabanlı genel amaçlı görüntü sınıflandırıcısı. 1000+ kategori, %94 doğruluk oranı.',
    'TENSORFLOW',
    'cat-edge',
    ['tag-ipfs', 'tag-federated', 'tag-nft'],
    '2.0.5',
    4,
  ),
  model(
    'duygu-analizi-tr',
    'Duygu Analizi TR',
    'Türkçe sosyal medya ve müşteri yorumları için gerçek zamanlı duygu sınıflandırma modeli.',
    'SKLEARN',
    'cat-language',
    ['tag-monad', 'tag-sum', 'tag-dao'],
    '1.2.0',
    6,
  ),
  model(
    ...
    'Gerçek zamanlı nesne tespiti için optimize edilmiş hafif YOLO varyantı. Uç cihazlarda çalışır.',
    'ONNX',
    'cat-edge',
    ['tag-federated', 'tag-ipfs', 'tag-nft'],
    '3.1.2',
  ...
  model(
    'finansal-tahmin-lstm',
    'Finansal Tahmin LSTM',
    'Zincir üstü token fiyatları ve DeFi protokol metrikleri için LSTM tabanlı tahmin motoru.',
    'PYTORCH',
    'cat-data',
    ['tag-monad', 'tag-dao', 'tag-sum'],
    '1.0.8',
    11,
  ),
  model(
    'kod-uretici-monad',
    'Kod Üretici Monad',
    'Monad akıllı kontrat geliştirme için özelleştirilmiş kod üreteci. Solidity ve Vyper destekler.',
    'TENSORFLOW',
    'cat-language',
    ['tag-safety', 'tag-monad', 'tag-dao'],
    '0.8.3',
  ...
  model(
    'konusma-tanima-tr',
    'Konuşma Tanıma TR',
    'Türkçe konuşma-metin dönüşümü için Whisper tabanlı fine-tuned model. %96 doğruluk.',
    'JAX',
    'cat-language',
    ['tag-ipfs', 'tag-nft', 'tag-federated'],
    '1.5.0',
    20,
  ),
  model(
    'tibbi-goruntu-analiz',
    'Tıbbi Görüntü Analiz',
    'Röntgen ve MRI görüntülerinde anomali tespiti. Gizlilik odaklı federe öğrenme ile eğitildi.',
    'PYTORCH',
    'cat-health',
    ['tag-federated', 'tag-sum', 'tag-ipfs', 'tag-monad'],
    '2.1.3',
    25,
  ),
  model(
    'metin-gömme-multilingual',
    'Çok Dilli Metin Gömme',
    '50+ dil destekli semantik metin gömme modeli. Pazar yeri semantik arama altyapısını güçlendirir.',
    'ONNX',
    'cat-language',
    ['tag-ipfs', 'tag-nft', 'tag-dao'],
    '1.3.7',
    30,
  ),
];
